...
module.exports.pad = function pad (num, str) {
  str = str || padStr
...
module.exports.wrapWithElement =function wrapWithElement (name, data, indentLevel) {
...
module.exports.parseString = function parseString(xml) {
...
module.exports.xml2obj = async function xml2obj(xml, objList) {
